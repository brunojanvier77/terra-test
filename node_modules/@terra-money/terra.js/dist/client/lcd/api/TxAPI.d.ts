...
export declare type AsyncTxBroadcastResult = Pick<BlockTxBroadcastResult, 'height' | 'txhash'>;
export declare namespace AsyncTxBroadcastResult {
    type Data = Pick<BlockTxBroadcastResult.Data, 'height' | 'txhash'>;
}
export declare type SyncTxBroadcastResult = Pick<BlockTxBroadcastResult, 'height' | 'txhash' | 'raw_log' | 'logs' | 'code' | 'codespace'>;
export declare namespace SyncTxBroadcastResult {
    type Data = Pick<BlockTxBroadcastResult.Data, 'height' | 'txhash' | 'raw_log' | 'logs' | 'code' | 'codespace'>;
}
